...
type HealthzDataPoint struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Datapoint:
	//
...
func (x *HealthzDataPoint) GetDatapoint() isHealthzDataPoint_Datapoint {
	if x != nil {
		return x.Datapoint
	}
	return nil
...
func (x *HealthzDataPoint) GetShowCommand() *ShowCommand {
	if x != nil {
		if x, ok := x.Datapoint.(*HealthzDataPoint_ShowCommand); ok {
...
func (x *HealthzDataPoint) GetSupportScript() *SupportScript {
	if x != nil {
		if x, ok := x.Datapoint.(*HealthzDataPoint_SupportScript); ok {
...
func (x *HealthzDataPoint) GetLogs() *Logs {
	if x != nil {
		if x, ok := x.Datapoint.(*HealthzDataPoint_Logs); ok {
			return x.Logs
		}
	}
	return nil
...
func (x *HealthzDataPoint) GetBashCommand() *BashCommand {
	if x != nil {
		if x, ok := x.Datapoint.(*HealthzDataPoint_BashCommand); ok {
...
const file_healthzdata_proto_rawDesc = "" +
	"\n" +
	"\x11healthzdata.proto\"[\n" +
	"\vHealthzData\x12\x18\n" +
	"\aversion\x18\x01 \x01(\rR\aversion\x122\n" +
	"\vdata_points\x18\x02 \x03(\v2\x11.HealthzDataPointR\n" +
	"dataPoints\"\xdb\x01\n" +
	"\x10HealthzDataPoint\x121\n" +
	"\fshow_command\x18\x01 \x01(\v2\f.ShowCommandH\x00R\vshowCommand\x127\n" +
	"\x0esupport_script\x18\x02 \x01(\v2\x0e.SupportScriptH\x00R\rsupportScript\x12\x1b\n" +
	"\x04logs\x18\x03 \x01(\v2\x05.LogsH\x00R\x04logs\x121\n" +
	"\fbash_command\x18\x04 \x01(\v2\f.BashCommandH\x00R\vbashCommandB\v\n" +
	"\tdatapoint\"E\n" +
	"\x04Logs\x12)\n" +
	"\x10logs_description\x18\x01 \x01(\tR\x0flogsDescription\x12\x12\n" +
	"\x04data\x18\x02 \x01(\fR\x04data\"D\n" +
	"\vShowCommand\x12!\n" +
	"\fshow_command\x18\x01 \x01(\tR\vshowCommand\x12\x12\n" +
	"\x04data\x18\x02 \x01(\fR\x04data\"D\n" +
	"\rSupportScript\x12\x1f\n" +
	"\vscript_name\x18\x01 \x01(\tR\n" +
	"scriptName\x12\x12\n" +
	"\x04data\x18\x02 \x01(\fR\x04data\";\n" +
	"\vBashCommand\x12\x18\n" +
	"\acommand\x18\x01 \x01(\tR\acommand\x12\x12\n" +
	"\x04data\x18\x02 \x01(\fR\x04datab\x06proto3"

var (
	file_healthzdata_proto_rawDescOnce sync.Once
	file_healthzdata_proto_rawDescData []byte
)

func file_healthzdata_proto_rawDescGZIP() []byte {
	file_healthzdata_proto_rawDescOnce.Do(func() {
		file_healthzdata_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_healthzdata_proto_rawDesc), len(file_healthzdata_proto_rawDesc)))
	})
...
func file_healthzdata_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_healthzdata_proto_rawDesc), len(file_healthzdata_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
